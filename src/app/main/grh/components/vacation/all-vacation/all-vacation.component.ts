...
export class AllVacationComponent implements OnInit {
  ...
  //   this.requestHolidayService.getHolidays(id).subscribe({
  //     next: (data) => {
  ...
  //   );
  //   this.holiday.finishDate = new Date(
  //     this.form.value.finishDate.year,
  //     this.form.value.finishDate.month,
  //     this.form.value.finishDate.day
  //   );
  //   console.log(this.holiday);
  //   this.requestHolidayService
  //     .updateHoliday(this.holiday.id, this.holiday)
  //     .subscribe({
  //       next: (data) => {
  ...
  //   this.requestHolidayService.deleteHoliday(this.idHoliday).subscribe({
  //     next: () => {
  //       this.getAllholidays();
  //     },
  //     error: (err) => {
  ...
  //   });
  //   this.requestHolidayService.deleteMultipleHoliday(this.ids).subscribe({
  //     next: () => {
  //       this.getAllholidays();
  //     },
  //     error: (err) => {
  ...
  //     name: this.name,
  //   };
  //   this.requestHolidayService.getHolidays(params).subscribe((response) => {
  ...
  //   };
  //   this.form = this.formBuilder.group({
  //     holidayTitle: ["", [Validators.required, Validators.minLength(3)]],
  //     holidayType: ["", [Validators.required, Validators.minLength(3)]],
  //     startDate: ["", [Validators.required, Validators.minLength(3)]],
  //     messageDetails: ["", [Validators.required, Validators.minLength(3)]],
